/****************************************************
 * Matthew Montada, 11/24/19, Pong Project
 */
package pongGame;
//Packages used to create the game's features
...
public class Game extends Canvas implements Runnable {
	...
	public Game() {
		...
		new Window("Pong Project", this);

		initialise();

		this.addKeyListener(new Inputs(leftPaddle, rightPaddle));
	...
	private void initialise() {
		...
		rightPaddle = new Paddle(Color.white, false);
